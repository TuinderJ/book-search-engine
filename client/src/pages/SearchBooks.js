...
const SearchBooks = () => {
  ...
  const [saveBook, { error }] = useMutation(SAVE_BOOK, { refetchQueries: [{ query: QUERY_USER }] });
            ...
            return (
              <Card key={book.bookId} border='dark'>
                ...
                <Card.Body>
                  ...
                  {Auth.loggedIn() && (
                    <Button disabled={savedBookIds?.some(savedBookId => savedBookId === book.bookId)} className='btn-block btn-info' onClick={() => handleSaveBook(book)}>
